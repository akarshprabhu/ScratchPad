...
public class texteditor1 extends JFrame {
	...
	public texteditor1() {
		...
		cut.setText(null); cut.setIcon(new ImageIcon("/home/akarsh/workspace/text editor/Test/src/cut.gif"));
		cop.setText(null); cop.setIcon(new ImageIcon("/home/akarsh/workspace/text editor/Test/src/copy.gif"));
		pas.setText(null); pas.setIcon(new ImageIcon("/home/akarsh/workspace/text editor/Test/src/paste.gif"));
		undo.setText(null); undo.setIcon(new ImageIcon("/home/akarsh/workspace/text editor/Test/src/undo.jpeg"));
		redo.setText(null); redo.setIcon(new ImageIcon("/home/akarsh/workspace/text editor/Test/src/redo.png"));
	...
	Action Open = new AbstractAction("Open",new ImageIcon("/home/akarsh/workspace/text editor/Test/src/open.gif")) {
	...
	Action Save = new AbstractAction("Save", new ImageIcon("/home/akarsh/workspace/text editor/Test/src/save.gif")) {
		public void actionPerformed(ActionEvent e) {
	...
	Action SaveAs = new AbstractAction("Save as...", new ImageIcon("/home/akarsh/workspace/text editor/Test/src/save.gif")) {
		public void actionPerformed(ActionEvent e) {
			saveFileAs();
		}
	};
	
	Action Quit = new AbstractAction("Quit",new ImageIcon("/home/akarsh/workspace/text editor/Test/src/exit.png")) {
		public void actionPerformed(ActionEvent e) {
			saveOld();
			System.exit(0);
		}
	...
	Action New=new AbstractAction("New", new ImageIcon("/home/akarsh/workspace/text editor/Test/src/new.gif")){
		public void actionPerformed(ActionEvent e){
			if(!currentFile.equals("Untitled"))
	...
	Action Find=new AbstractAction("Find",new ImageIcon("/home/akarsh/workspace/text editor/Test/src/find.png")){
		public void actionPerformed(ActionEvent e){
	...
	Action Replace= new AbstractAction("Replace",new ImageIcon("/home/akarsh/workspace/text editor/Test/src/replace.png")){
		public void actionPerformed(ActionEvent e){
			String text=area.getText();
			int p0=0;
	...
	Action Undo=new AbstractAction("Undo",new ImageIcon("/home/akarsh/workspace/text editor/Test/src/undo.jpeg")){
		public void actionPerformed(ActionEvent e){
			try{ 
			manager.undo();}
	...
	Action Redo=new AbstractAction("Redo",new ImageIcon("/home/akarsh/workspace/text editor/Test/src/redo.png")){
		public void actionPerformed(ActionEvent e){
			try {
			manager.redo();}
	...
	Action Clear=new AbstractAction("Clear",new ImageIcon("/home/akarsh/workspace/text editor/Test/src/clear.jpeg")){
		public void actionPerformed(ActionEvent e){
			String text=area.getText();
			int start=0;
			int end=text.length();
	...
	Action selectAll=new AbstractAction("Select All",new ImageIcon("/home/akarsh/workspace/text editor/Test/src/all.png")){
		public void actionPerformed(ActionEvent e){
			area.selectAll();
		}
	};
